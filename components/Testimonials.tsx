...
const testimonials = [
  {
    ...
    quote:
      "Antje Kaufmanns Training hat meine wissenschaftliche Präsentation auf internationalem Parkett grundlegend verändert. Professionell, empathisch und überaus effektiv.",
    initials: "SM",
  },
  {
    name: "Thomas Bauer",
